    ...
    <form  method="post" class="form-element">
      ...
      <div class="row">
        ...
        <div class="col-12 text-center">
          <p>You Have To Register in This Site ? <a href="restraunt_register.php"> Register Now </a></p>
...
$check_avail="select * from tbl_restraunt where login_email='$email' AND login_pass='$pass'";
