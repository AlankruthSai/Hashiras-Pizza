  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> Add Base</li>
      </ol>
    </section>
...
if(isset($_POST['cat_sub']))
{
  ...
  $ins_cat="INSERT INTO tbl_base(base_name,base_price) VALUES ('$v_name','$v_price')";
  $run_cat=mysqli_query($con,$ins_cat);


if($run_cat)
{
   echo "<script>alert('Base Successfully Created')</script>";
    echo "<script>window.open('add_base.php','_self')</script>";
}

else {
   echo "<script>alert('Base Not Successfully Added')</script>";
    echo "<script>window.open('add_base.php','_self')</script>";
}
